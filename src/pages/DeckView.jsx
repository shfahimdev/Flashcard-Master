...
import { ArrowLeft, Plus, Zap, Brain, FileText, Edit, Trash2, Upload } from 'lucide-react'
...
function DeckView() {
  ...
  return (
    <div className="min-h-screen p-8">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500 mt-2">{deck.cards.length} cards</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-sm opacity-90">Flip through cards</div>
              </div>
            </motion.button>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-sm opacity-90">Study with tracking</div>
              </div>
            </motion.button>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-sm opacity-90">Take a quiz</div>
              </div>
            </motion.button>
          </div>
                ...
                >
                  <div className="flex justify-between gap-4">
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <div className="text-xs font-semibold text-gray-500 uppercase mb-1">Front</div>
                        <div className="text-gray-900">{card.front}</div>
                      </div>
                      <div>
                        <div className="text-xs font-semibold text-gray-500 uppercase mb-1">Back</div>
      ...
      {showAddModal && <AddCardModal deckId={id} onClose={() => setShowAddModal(false)} />}
      {editingCard && <EditCardModal deckId={id} card={editingCard} onClose={() => setEditingCard(null)} />}
      {showBulkImport && <BulkImportModal deckId={id} onClose={() => setShowBulkImport(false)} />}
    </div>
  )
}
